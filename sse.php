...
while (true) {
    ...
    if ($check_result->num_rows > 0) {
        // Ada pasangan yang belum selesai, tampilkan detail pasangan yang belum diproses
        while ($row = $check_result->fetch_assoc()) {
            ...
            // Tampilkan pasangan yang belum diproses
            $message = "Pasangan belum diproses: Pria: {$male['username']} (ID: {$male_user_id}) dan Wanita: {$female['username']} (ID: {$female_user_id})";
            sendMessage($message);
        }
    } else {
